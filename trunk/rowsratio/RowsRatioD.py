...
class TTotal(cTerr):
    ...
    [5  , 'Средняя численность работников (включая выполнявших работы по договорам гражданско-правового характера),чел.',                                              'tab_33(01-09)_list1.xls', 'tab_33(01-09)_list1-corr',4 ,'СЧР С СХ 2008.xls',      ''],
    [8  , 'Выручка (нетто) от продажи товаров, продукции, работ, услуг (без НДС, акцизов и аналогичных обязательных платежей),тыс.руб.',                               'tab_33(12)_list1.xls',    'tab_33(12)_list1-corr'   ,13,'Выручка2008.xls',''],
    [11 , 'Инвестиции в основной капитал (в части новых и приобретённых по импорту основных средств) - всего,тыс.руб.',                                                'tab_33(13)_list1.xls',    'tab_33(13)_list1-corr'   ,14,'Инвестиции2008.xls',''],
